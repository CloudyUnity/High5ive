...
final int DEFAULT_CHECKBOX_CHECKED_COLOUR = COLOR_RED;
final int DEFAULT_RADIOBUTTON_CHECKED_COLOUR = COLOR_RED;
final int DEFAULT_SLIDER_FILLED_COLOUR = COLOR_BLUE;
